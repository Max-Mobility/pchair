...
set(BUILD_COMPONENTS soc;spi_flash;micro-ecc;bootloader_support;main;esptool_py;partition_table;esp32;log;bootloader)
...
function(get_component_requirements component var_requires var_private_requires)
  ...
  if("${component}" STREQUAL "esp32")
    set(${var_requires} "bootloader;main;bootloader_support;esp32;esptool_py;log;micro-ecc;partition_table;soc;spi_flash" PARENT_SCOPE)
    set(${var_private_requires} "" PARENT_SCOPE)
    return()
  endif()

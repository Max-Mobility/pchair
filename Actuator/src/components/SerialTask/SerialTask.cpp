...
namespace SerialTask {
  ...
  char leftSpeed[2];
  char rightSpeed[2];
  char rampSpeedUP		=	6;   //6% per cycle
  char rampSpeedDown	=	18; //18% per cycle
  ...
  void taskFunction ( void *pvParameter ) {
    ...
    uart_set_pin(UART_NUM_1, GPIO_NUM_15, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE);

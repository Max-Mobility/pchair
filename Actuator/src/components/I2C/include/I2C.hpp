...
#define ESP_SLAVE_READ_ADDR                                                    \
  0x52 // 0x20//0x52 			//JOYSTICK USE DIFFERENT ADDRESS FOR READ
       // AND WRITE
#define ESP_SLAVE_WRITE_ADDR                                                   \
  0x52 // 0x20//0x52 			/*!< ESP32 slave address, you can set any
       // 7bit value */
